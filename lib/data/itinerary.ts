...
export const itinerary: ItineraryDay[] = [
  ...
  // ---- NORTH CHANNEL / MANITOULIN ----
  {
    ...
    leg: "north-channel", route: "both", overnight: "Drummond Island Yacht Haven",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Meldrum Bay Marina",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Gore Bay Marina",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Spider Bay Marina or Anchor Inn dock, Little Current",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Anchor in Baie Fine 'The Pool', or slip at Killarney Municipal Marina",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Big Tub Harbour, Tobermory",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Kincardine Marina",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Sarnia Bay Marina (Canada) or Port Huron area marina (US)",
  ...
  },
  {
    ...
    leg: "north-channel", route: "both", overnight: "Detroit City Marina or Wyandotte area",
  ...
  {
    day: 30, from: "New York Harbor", to: "Manasquan Inlet, NJ", distanceNm: 35, locks: 0,
  ...
  {
    day: 31, from: "Manasquan, NJ", to: "Atlantic City, NJ", distanceNm: 60, locks: 0,
  ...
  {
    day: 32, from: "Atlantic City, NJ", to: "Cape May, NJ", distanceNm: 40, locks: 0,
  ...
  {
    day: 33, from: "Cape May, NJ", to: "Delaware City, DE", distanceNm: 55, locks: 0,
  ...
  {
    day: 34, from: "Delaware City, DE", to: "Philadelphia, PA", distanceNm: 40, locks: 0,
